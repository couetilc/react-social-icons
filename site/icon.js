...
/***/ function(module, exports, __webpack_require__) {
	...
	var networks = __webpack_require__(1);
	var SocialIcon = __webpack_require__(2);
	var SocialIcons = __webpack_require__(3);

	var lib = React.createElement(
	  "div",
	  null,
	  networks.KEYS.map(function (k) {
	    return React.createElement(SocialIcon, { network: k, title: k, key: k });
	  })
	);

	var urlExample = React.createElement(SocialIcon, { url: "http://linkedin.com/in/jaketrent" });

	var networkExample = React.createElement(SocialIcon, { network: "tumblr", url: "http://jaketrent.com" });

	var colorExample = React.createElement(SocialIcon, { network: "twitter", color: "#ff5a01" });
	...
	var iconsExample = React.createElement(SocialIcons, { urls: urls, className: "med" });

	var iconsColorExample = React.createElement(SocialIcons, { urls: urls, color: "black", className: "sm" });

	var sizes = React.createElement(
	  "div",
	  null,
	  React.createElement(SocialIcon, { network: "pinterest", className: "sm" }),
	  React.createElement(SocialIcon, { network: "pinterest", className: "med" }),
	  React.createElement(SocialIcon, { network: "pinterest", className: "lrg" }),
	  React.createElement(SocialIcon, { network: "pinterest", className: "xlrg" })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  getNetworkKey: function getNetworkKey() {
	  ...
	  render: function render() {
	    return React.createElement(
	      "a",
	      _extends({}, this.props, { ref: "link", href: this.props.url, target: "_blank", className: this.getClassName() }),
	      React.createElement(
	        "div",
	        { className: "social-container" },
	        React.createElement(
	          "svg",
	          { className: "social-svg", viewBox: "0 0 64 64" },
	          React.createElement(Background, { ref: "background" }),
	          React.createElement(Icon, { ref: "icon", networkKey: this.getNetworkKey() }),
	          React.createElement(Mask, { ref: "mask", networkKey: this.getNetworkKey(), color: this.props.color })
	        )
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  renderIcons: function renderIcons() {
	    var _this = this;
	    return this.props.urls.map(function (url, i) {
	      return React.createElement(SocialIcon, { key: i, url: url, color: _this.props.color, className: _this.props.className });
	    });
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "g",
	      _extends({}, this.props, { className: "social-svg-background" }),
	      React.createElement("circle", { cx: "32", cy: "32", r: "31" })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "g",
	      _extends({}, this.props, { className: "social-svg-icon" }),
	      React.createElement("path", { d: networks.iconFor(this.props.networkKey) })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "g",
	      _extends({}, this.props, { className: "social-svg-mask", style: this.getStyle() }),
	      React.createElement("path", { d: networks.maskFor(this.props.networkKey) })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/jtrent/dev/react-social-icons/node_modules/css-loader/index.js!/Users/jtrent/dev/react-social-icons/node_modules/autoprefixer-loader/index.js?browsers=last 2 version!/Users/jtrent/dev/react-social-icons/node_modules/sass-loader/index.js!/Users/jtrent/dev/react-social-icons/lib/social-icon.scss", function() {
			var newContent = require("!!/Users/jtrent/dev/react-social-icons/node_modules/css-loader/index.js!/Users/jtrent/dev/react-social-icons/node_modules/autoprefixer-loader/index.js?browsers=last 2 version!/Users/jtrent/dev/react-social-icons/node_modules/sass-loader/index.js!/Users/jtrent/dev/react-social-icons/lib/social-icon.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".social-icon {\n  display: inline-block;\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n  position: relative;\n  overflow: hidden;\n  vertical-align: middle; }\n\n.social-icon .social-container {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%; }\n\n.social-icon .social-svg {\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  fill-rule: evenodd; }\n\n.social-svg-background, .social-svg-icon, .social-svg-mask {\n  transition: fill 170ms ease-in-out;\n  fill: transparent; }\n\n.social-svg-mask {\n  fill: #0f0b0b; }\n", ""]);
